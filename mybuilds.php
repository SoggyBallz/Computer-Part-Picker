...
// Query to retrieve the user's computers and component information
$query = "SELECT pc.id, pc.name, cpu.name as cpu_name, gpu.name as gpu_name, psu.name as psu_name, 
                ...
                cpu.price as cpu_price, gpu.price as gpu_price, psu.price as psu_price, motherboard.price as motherboard_price, 
